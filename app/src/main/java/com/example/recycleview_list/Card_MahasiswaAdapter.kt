...
class Card_MahasiswaAdapter(private val context: Context, private  val dataList: List<Inis_Variable>,
                            val listener: (Inis_Variable) -> Unit) : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
